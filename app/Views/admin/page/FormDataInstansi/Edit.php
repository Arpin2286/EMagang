                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        placeholder="Nama Intansi" value="Nama Instansi Lama" autofocus>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput">Kode Instansi</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        placeholder="Kode Intansi" value="Kode Lama" disabled>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="inlineFormInputGroup"
                                            placeholder="-8.12433824027323" value="Koordinat Lama">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="text" class="form-control" id="inlineFormInputGroup"
                                            placeholder="115.09501411248277" value="Koordinat Lama">
                                    </div>
