                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        placeholder="Nama Peserta" value="Nama Lama" autofocus>
                                </div>
                                <div class="form-group">
                                    <label for="formGroupExampleInput">NIS/NIM</label>
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        placeholder="1904xxx" value="NIS/NIM Lama">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="email" class="form-control" id="inlineFormInputGroup"
                                            placeholder="example@gmail.com" value="Email Lama" disabled>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-2">
                                        ...
                                        <input type="email" class="form-control" id="inlineFormInputGroup"
                                            placeholder="nonamed123" value="Username Lama" disabled>
                                    </div>
                                    <small class="form-text text-muted">Disarankan menggunakan email
                                        sekolah/universitas</small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput"
                                        placeholder="08xxxxxxx" value="Nomor HP Lama">
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
